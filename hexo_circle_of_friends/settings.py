...
LINK = [
    {
        "link": "https://icodeq.com/link/",  # 友链页地址1，修改为你的友链页地址
        "theme": "butterfly"
    },
    #     {
...
SETTINGS_FRIENDS_LINKS = {
    ...
    "list": [
#         # 示例1：
          ["ZkeqのCoding日志", "https://coding.maylove.pub/", "https://ik.imagekit.io/zkeq/Avatar.jpg", "https://json.icodeq.com/json/zkeq/coding"],
